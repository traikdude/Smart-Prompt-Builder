...
const path = 'C:/Users/traik/.gemini/antigravity/brain/11ba3034-0051-4e76-946c-0046ae47a632/.system_generated/steps/322/output.txt';
const data = JSON.parse(fs.readFileSync(path, 'utf8'));
const answer = data.data.answer;

const startIndex = answer.indexOf('# google-sheets-architect');
...
console.log('Successfully injected Elite Google Sheets Architect as a new template!');
