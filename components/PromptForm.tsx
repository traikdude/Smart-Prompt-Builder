      ...
      <div className="mt-4 pt-4 border-t border-slate-700/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <button
              ...
              disabled={isLoading || !userContent.trim()}
              title="Rapid AI generation optimized for speed. Use for simple formatting or short text tasks."
          ...
          <button
              ...
              disabled={isLoading || !userContent.trim()}
              title={`Advanced AI reasoning using Gemini ${modelFamily === '2.5' ? '2.5 Pro' : '3.1 Pro'} with extended thinking. Best for complex logic, algorithms, and deep analysis.`}
        ...
        {/* Mobile Info Text for Action Buttons */}
        <div className="md:hidden mt-4 space-y-2 text-[10px] text-slate-500 px-2 bg-slate-900/30 p-3 rounded-lg border border-slate-700/30">
           <p className="font-semibold text-slate-400 mb-1">Mode Guide:</p>
           <p><span className="text-purple-400">✨ Smart:</span> Standard logic & speed balance.</p>
           <p><span className="text-amber-400">⚡ Fast:</span> Rapid output for quick formatting.</p>
           <p><span className="text-emerald-400">🧠 Deep:</span> Advanced reasoning for complex analysis.</p>
        </div>
      </div>
